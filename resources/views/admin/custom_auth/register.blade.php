    ...
    <div class="log-w3">
        <div class="w3layouts-main">
            ...
            <form action="{{ URL::to('/register') }}" method="post">
                {{ csrf_field() }}
                <input type="text" class="ggg" name="name" value="{{old('name')}}" placeholder="Nhập NAME" required="">
                <input type="text" class="ggg" name="email" placeholder="Nhập E-MAIL" required="">
                <input type="text" class="ggg" name="phone" value="{{old('phone')}}" placeholder="Nhập PHONE" required="">
            ...
            <a href="{{ url('/login-auth') }}">Sign In Auth</a>
