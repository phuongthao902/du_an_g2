                        ...
                        <form role="form" action="{{ URL::to('save-product') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="resize: none" rows="10" class="form-control" name="product_desc" id="exampleInputPassword1"
                                    placeholder="Description of the song"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Product price</label>
                                <input type="number" name="unit_price" class="form-control"
                                    id="exampleInputEmail1" placeholder="Product price">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="product_origin" class="form-control input-sm m-bot15">
                                    @foreach ($product_origin as $key => $origin)
